...
//    Call<GetRevDept> getRevDeptTest();
    ...
    //진료과 의사
    @GET("getreq?domain=com&submit_id=TRZIF00024&hospitalCd=031&business_id=com")
    Call<GetRevDoc> getRevDoc(@Query("departmentCd") String departmentCd, @Query("pId") String pId);

    //의사의 예약가능날짜
    @GET("getreq?domain=com&submit_id=TRZIF00020&business_id=com&hospitalCd=031&reglscheyn=N&internetyn=Y")
    ...
    //날짜에 시간
    @GET("getreq?domain=com&submit_id=TRZIF00021&hospitalCd=031&business_id=com")
    ...
    //진료예약
    @POST("postreq?domain=com&submit_id=TXZIF00025&hospitalCd=031&business_id=com&histstat=T")
    ...
    //예약 리스트
    @GET("getreq?domain=com&submit_id=TRZIF00022&hospitalCd=031&business_id=com")
    Call<GetRevList> getRevList(@Query("pId") String pId, @Query("startDt") String startDt, @Query("endDt") String endDt);

    //예약 취소
    @POST("postreq?domain=com&submit_id=TXZIF00025&hospitalCd=031&business_id=com&histstat=X")
    ...
    //차량번호 수정
    @POST("postreq?domain=hit&submit_id=TXZIF00010&business_id=com&hospitalCd=031")
    Call<UpdateVehicleNo> updateVehicleNo(@Query("pId") String pId, @Query("vehicleNo") String vehicleNo);

    //환자 전화번호 수정
    @POST("postreq?domain=hit&submit_id=TXZIF00008&business_id=com&hospitalCd=031")
