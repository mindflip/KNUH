...
import com.example.user.knuhui.dicom.dicom.data.DICOMMetaInformation;
import com.example.user.knuhui.dicom.dicom.file.DICOMReader;
...
public class DICOMFileChooser extends ListActivity {
	...
	private boolean grantExternalStoragePermission() {
		if (Build.VERSION.SDK_INT >= 23) {
			if (checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
				Log.v("permissionGrant", "Permission is granted");
				return true;
			} else {
	...
	private void fill() {
        ...
        Log.i("mTopDirectory","///////////****" + mTopDirectory.getPath());
	...
	private void displayDisclaimer() {
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(this);
		builder.setMessage("Droid Dicom Viewer is a Free and Open Source" +
				" Software (FOSS) licensed under the terms of the GNU General Public" +
				" License as published by the Free Software Foundation, either version 3 " +
				"of the License, or (at your option) any later version.\n\n" +
				"THIS VERSION OF DROID DICOM VIEWER IS NOT CERTIFIED AS A MEDICAL DEVICE " +
				...
				"CLINICAL PRACTICE.\n\n" +
				"Dicom Droid Software is distributed in the hope that it will be useful, " +
